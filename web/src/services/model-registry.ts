...
import { aiProviderService } from './admin/ai-provider-service';
...
class ModelRegistry {
  ...
  private initializeDefaultModels() {
    const defaultModels: ModelInfo[] = [
      ...
      },
      {
        ...
        provider: 'sensenova',
        type: 'image',
        description: '轻量信息图生成，2K分辨率，11种宽高比可选，性价比最高',
        capabilities: ['text-to-image', 'negative-prompt'],
        maxResolution: '3072x3136',
        costPerImage: 0.01,
        estimatedSpeed: 'fast',
        qualityRating: 4.3,
        isActive: true,
        isPopular: true,
        tags: ['图片', 'SenseNova', '2K', '信息图', '性价比'],
      ...
      },
      {
        ...
        provider: 'stepfun',
        type: 'image',
        description: '高质量图片生成与编辑模型，支持文生图、图生图和参考图编辑',
        capabilities: ['text-to-image', 'image-to-image', 'image-edit', 'reference'],
        maxResolution: '1360x768',
        costPerImage: 0.08,
        estimatedSpeed: 'medium',
        qualityRating: 4.5,
        isActive: true,
        tags: ['StepFun', '图片编辑', '图生图'],
      ...
      },
      {
        ...
        type: 'image',
        description:
          'Agnes Image 2.1 Flash 图像生成模型，支持文生图与图生图，高信息密度图像优化，构图保持，灵活尺寸控制，最高 4K 输出',
        capabilities: ['text-to-image', 'image-to-image', 'reference', 'image-edit'],
        costPerImage: 0.05,
        estimatedSpeed: 'fast',
        qualityRating: 4.3,
        isActive: true,
        tags: ['图片', 'Agnes', '快速', '小天', '4K', '图生图'],
        supportedModes: ['text_to_image', 'image_to_image'],
        supportedAspectRatios: ['1:1', '4:3', '3:4', '16:9', '9:16', '3:2', '2:3', '21:9', '9:21'],
      ...
      },
      {
        ...
        type: 'video',
        description:
          'Agnes-Video-V2.0 视频生成模型，支持文生视频、图生视频、多图视频与关键帧动画，每秒8积分，价格优惠',
        capabilities: [
          'text-to-video',
          'image-to-video',
          'video-to-video',
        ...
        maxResolution: '1152x768',
        maxDuration: 18,
        supportedDurations: [6, 8, 10, 12, 15, 18],
        costPerMinute: 0.48,
        estimatedSpeed: 'medium',
        qualityRating: 4.5,
        isActive: true,
        isPopular: true,
        tags: ['视频生成', 'Agnes', 'XT', '独立通道', '价格优惠', '推荐'],
      ...
      },
      {
        ...
        provider: 'stepfun',
        type: 'audio',
        description: '高表现力 Contextual TTS，支持全局语境与文中语境控制，适合高表现力配音',
        capabilities: ['text-to-speech', 'instruction-control', 'contextual-tts'],
        costPerMinute: 0.1,
        estimatedSpeed: 'fast',
        qualityRating: 4.8,
        isActive: true,
        isPopular: true,
        tags: ['音频', 'TTS', '语音合成', 'StepFun', '推荐', '优先'],
        voiceOptions: [
  ...
  public getModelsByProvider(provider: APIProvider): ModelInfo[] {
    return Array.from(this.models.values()).filter((m) => m.provider === provider && m.isActive);
  }
