...
export const OFFICIAL_VIDEO_MODEL_CAPABILITIES: OfficialVideoModelCapability[] = [
  ...
  },
  {
    ...
    label: 'XT模型 ⭐价格优惠',
    badge: '8/s',
    aliases: ['agnes-video-v2.0', 'Agnes-Video-V2.0', 'agnes_video_v2'],
    officialModel: 'agnes-video-v2.0',
    modes: ['text_to_video', 'image_to_video'],
    fields: ['aspectRatio', 'resolution', 'duration', 'seed', 'payload'],
    aspectRatios: ['16:9', '9:16'],
    resolutions: ['720p', '1080p'],
    durations: [6, 8, 10, 12, 15],
    // Agnes 帧数上限：1080p=241帧(≈10s)，720p=481帧(≈15s)
    ...
    notes: ['Agnes-Video-V2.0 测试模型，每秒8积分。'],
  },
  {
