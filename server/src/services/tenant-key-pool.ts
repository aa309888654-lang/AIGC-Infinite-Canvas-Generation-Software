...
const TIER_CONFIGS: Record<TenantTier, Omit<TenantConfig, 'tenantId' | 'dailyRequestCount'>> = {
  free: {
    ...
    priorityLevel: 0,
    allowedProviders: ['vidu', 'doubao', 'wuyinkeji'],
    allowedModels: ['viduq2-turbo', 'viduq2', 'viduq3-turbo', 'doubao-seedance-2-0', 'doubao-seedance-2-0-fast', 'Wan2.7_image', 'google_omni', 'veo3.1_fast', 'Wan2.6_video', 'Wan2.7', 'sora2', 'video_vidu', 'video_omni', 'video_seedance', 'Digital_Humans', 'Package_1.0'],
  ...
  basic: {
    ...
    priorityLevel: 1,
    allowedProviders: ['vidu', 'doubao', 'wuyinkeji'],
    allowedModels: ['viduq3-turbo', 'viduq3-pro-fast', 'viduq2-pro', 'viduq2-turbo', 'viduq2', 'viduq3-mix', 'doubao-seedance-2-0', 'doubao-seedance-2-0-fast', 'Wan2.7_image', 'google_omni', 'veo3.1_fast', 'Wan2.6_video', 'Wan2.7', 'sora2', 'video_vidu', 'video_omni', 'video_seedance', 'Digital_Humans', 'Package_1.0'],
    dailyRequestLimit: 20,
  },
  premium: {
    tier: 'premium',
    ...
    priorityLevel: 2,
    allowedProviders: ['vidu', 'doubao', 'wuyinkeji'],
    allowedModels: ['viduq3-pro', 'viduq3-turbo', 'viduq3-pro-fast', 'viduq3-mix', 'viduq2-pro', 'viduq2-turbo', 'viduq2-pro-fast', 'viduq2', 'doubao-seedance-2-0', 'doubao-seedance-2-0-fast', 'doubao-seedance-1-5-pro', 'Wan2.7_image', 'google_omni', 'veo3.1_fast', 'Wan2.6_video', 'Wan2.7', 'sora2', 'video_vidu', 'video_omni', 'video_seedance', 'Digital_Humans', 'Package_1.0'],
