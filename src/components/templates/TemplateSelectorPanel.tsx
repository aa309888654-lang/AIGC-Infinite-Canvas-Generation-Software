...
import { Sparkles, Film, Type, Layers, Palette, Wand2, Layout, Search, Crown, Check, X, ChevronLeft, ChevronRight, User, Mountain, Package, Building, UtensilsCrossed, Shirt, Camera, Clapperboard, Sun, Frame, Settings } from 'lucide-react';
...
interface TemplatePanelProps { onSelect?: (template: Template) => void;
  onClose?: () => void; }
        ...
        <div className="border-t border-[#2d2d35] bg-[#15151a]">
          {!showVisualEditor ? (
            ...
            <VisualTemplateEditor
              ...
              onParametersChange={(_params) => { /* 参数变更回调 */ }}
              onPreview={() => { /* 预览回调 */ }}
              onSave={(_params) => {
