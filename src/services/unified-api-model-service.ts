...
class UnifiedAPIModelService {
  ...
  private readonly fixedDefaultModelIds: Record<'image' | 'video', string[]> = {
    image: ['doubao-seedream-5-0-lite', 'doubao-seedream-5-0-pro'],
    video: ['doubao-seedance-2-0', 'viduq3-turbo', 'viduq3-pro', 'kling-3.0-turbo', 'kling-3.0'],
  };
  ...
  private readonly membershipDefaultModelPriority: Record<string, Record<'image' | 'video', string[]>> = {
    ...
    free: {
      ...
      video: ['doubao-seedance-2-0', 'kling-3.0-turbo', 'kling-3.0', 'viduq3-turbo', 'viduq3-pro'],
    },
  };
